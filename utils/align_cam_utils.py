...
def corresponding_cameras_alignment(
    ...
    cameras_aligned = align_cameras_from_solution(cameras_src, align_t_R, align_t_T, align_t_s)

    if return_solution:
        return cameras_aligned, (align_t_R, align_t_T, align_t_s)
    else:
        return cameras_aligned


def align_cameras_from_solution(cameras_src, align_t_R, align_t_T, align_t_s):
